...
Desde Cañada de los Morteros, salimos a la derecha para hacerle la foto al límite, vamos hasta la rotonda de la salida 39 de la **`🟧A-92N🟧`** y volvemos. Si nos vemos con gana podemos ir a Cuevas del Campo.
...
* **`🟩A-338🟩`** (43,44 km): Parece no haber Km 0, hacer foto al principio de la carretera
...
> - Duración: 2h
> - Desnivel: 375m+
> - Transporte: Bus hasta Cruce Cc-332/Gr-433 y Bus desde La Rábita a Granada
> - Logística: 🔧🚌
...
Hacemos toda la **`🟩A-345🟩`** hasta La Rábita, nos bañamos y volvemos en bus a Granada.
...
* **`🟨GR-5200🟨`** (1,10 km): Al parecer el límite no se encuentra, Hacer foto al Km 1
* **`🟨A-4102🟨`** (2,89 km)
...
Dejamos el coche en Guadix y salimos hacia el sur haciendo la **`🟨A-4101R🟨`**, vamos a Jérez del Marquesado, Lanteira, Alquife y La Calahorra terminando la **`🟨GR-5104🟨`**. Luego vamos a Aldeire girando la derecha hacia la **`🟨GR-5201🟨`** y salimos de La Calahorra por la vía de Google Maps (y a poder ser ir y volver de Ferreira haciendo la **`🟨GR-5200🟨`**) hasta la vía de servicio de la **`🟧A-92🟧`** y en la salida 307/308 nos hacemos la **`🟨A-4102🟨`**. En Alcudia de Guadix, giramos a la derecha hasta la rotonda de la salida 303 de la **`🟧A-92🟧`** y nos hacemos la **`🟨A-4101🟨`** hasta volver a Guadix. Antes de terminarla podemos revisar la "supuesta" **`🟨A-4102R🟨`** (Pejemofe). Cuando lleguemos a Guadix, podemos intentar hacer la **`🟨A-325R🟨`** (en el norte).
...
> - Duración: 2h 45min
> - Desnivel: 730m+
> - Transporte: Bus hasta Venta Barbero y Bus desde La Rábita a Granada
> - Logística: 🔧🚌

### Carreteras

* **`🟨A-4131🟨`** (34,55 km): Parece que el límite es el km 33

### Itinerario

Hacemos la **`🟨A-4131🟨`** desde Venta Barbero hasta Albuñol, bajamos a La Rábita a bañarnos y volvemos en bus a Granada.
...
## Ruta Alfornón y Sorvilán

> - Duración: 2h
> - Desnivel: 350m+
> - Transporte: Bus hasta Haza del Lino
> - Logística: 🔧🚌🤵

### Carreteras

* **`🟨GR-5203🟨`** (4,7 km): En realidad el límite es el Km 4
* **`🟨GR-6203🟨`** (8,8 km): No sabemos el límite

### Itinerario

Salimos desde Haza del Lino por la **`🟨GR-5204🟨`** y vamos a Alfornón haciendo la **`🟨GR-5203🟨`**. Volvemos por donde vemos venido y después seguimos por la **`🟨A-4131🟨`** hasta hacer la **`🟨GR-6203🟨`** pasando por Sorvilán y llegando a Castillo de Baños donde nos recogerán.
...
> Duración: 1h 30min
> Desnivel: 150m+
> Transporte: Bus hasta Venta del Empalme (Venta Nueva)
> Logística: 🔧🚌🤵

### Carreteras

* **`🟨GR-5204🟨`** (13,2 km): En realidad el límite es el Km 13
* **`🟨GR-6204🟨`** (14,4 km): En realidad el límite es el Km 14

### Itinerario

Salimos desde Venta Nueva y vamos a Haza del Lino haciendo la **`🟨GR-5204🟨`**. Después seguimos por la **`🟨A-4131🟨`** hasta hacer la **`🟨GR-6204🟨`** pasando por Polopos y llegando a Castillo de Baños donde nos recogerán.
